...
function series2() {
  var qwe = [
    {
      name: "Buy",
      data: generateDayWiseTimeSeries1(0, 30),
    },
    {
      name: "Sell",
      data: generateDayWiseTimeSeries1(1, 30),
    },
  ];
  return qwe;
}
...
socket.on("randomValue", function (randomNumber) {
  var item = document.getElementById("rad");
  item.textContent = "$" + randomNumber + "USD";
});
